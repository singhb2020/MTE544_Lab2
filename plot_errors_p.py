...
def plot_errors(filename_e, filename_pos):
    ...
    title = "Derivative Error (m/s) vs. Error (m) for P-control (Klp = 0.21, Kap = 1)"
    ...
    title = "Error (m) / Derivative Error (m/s) vs Time (ns) for P-control (Klp = 0.21, Kap = 1)"
    ...
    title = "Y-Position (m) vs. X-Position (m) for P-control (Klp = 0.21, Kap = 1)"
    ...
    title = r"X (m) / Y (m) / $\theta$ (rad) vs Time (ns) for P-control (Klp = 0.21, Kap = 1)"
    wrapped_title = "\n".join(textwrap.wrap(title, width=47))
