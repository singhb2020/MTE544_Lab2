...
def plot_errors(filename_e_l, filename_e_a, filename_pos):
    ...
    title = "Y-Position (m) vs. X-Position (m) for PID-control on a Parabolic Trajectory"
    ...
    title = "Linear Error (m) / Angular Error (rad) vs Time (ns) for PID-control on a Parabolic Trajectory"
